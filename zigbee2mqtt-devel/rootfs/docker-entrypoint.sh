...
bashio::config.require 'zigbee2mqtt_fork'

ZIGBEE2MQTT_FORK=$(bashio::config 'zigbee2mqtt_fork')
BUILD_BRANCH=$(bashio::config 'build_branch')

# Clone and install zigbee2mqtt

echo "Clonning zigbee2mqtt"
git clone -b $BUILD_BRANCH --single-branch --depth 1 $ZIGBEE2MQTT_FORK /app
mkdir /app/dist
